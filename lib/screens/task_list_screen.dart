...
import 'package:todolistapp/screens/profile_screen.dart';
import 'package:todolistapp/screens/update_task_screen.dart';
      ...
      body: StreamBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData && !snapshot.hasError) {
            ...
            // Kiểm tra và chuyển đổi giá trị từ DataSnapshot thành Map<String, dynamic>
            if (snapshot2 is Map) {
